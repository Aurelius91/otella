	...
	<script type="text/javascript">
		...
		function addCategory() {
			...
			var categoryType = $('#category-type-add').val();
		...
		function editCategory() {
			...
			var categoryType = $('#category-type-edit').val();
			...
			$.ajax({
				...
				success: function(data){
					if (data.status == 'success') {
						...
						$('#category-type-container-edit').dropdown('set selected', data.category.type);
						$('#category-image-edit').val("");
						$('#category-image-edit').data('image_id', 0);
				...
				<div class="form-content">
					<div class="ui form">
						<div class="two fields">
							...
							<div class="field">
								<label>Type</label>
								<div id="category-type-container-add" class="ui search selection dropdown form-input">
									<input id="category-type-add" type="hidden" class="data-important">
									<i class="dropdown icon"></i>
									<div class="default text">-- Select Type --</div>
									<div class="menu">
										<div class="item" data-value="category">category</div>
										<div class="item" data-value="looks">looks</div>
									</div>
								</div>
							</div>
						</div>
				...
				<div class="form-content">
					<div class="ui form">
						<div class="two fields">
							...
							<div class="field">
								<label>Type</label>
								<div id="category-type-container-edit" class="ui search selection dropdown form-input">
									<input id="category-type-edit" type="hidden" class="data-important">
									<i class="dropdown icon"></i>
									<div class="default text">-- Select Type --</div>
									<div class="menu">
										<div class="item" data-value="category">category</div>
