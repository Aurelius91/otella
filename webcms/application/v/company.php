						...
						<div class="field">
							<div class="three fields">
								<div class="field">
									...
									<input id="setting-facebook-url" placeholder="Facebook URL" type="text">
								</div>
								<div class="field">
									<label>Twitter URL</label>
									<input id="setting-twitter-url" placeholder="Twitter URL" type="text">
								</div>
								<div class="field">
									<label>Instagram URL</label>
									<input id="setting-instagram-url" placeholder="Instagram URL.." type="text">
								</div>
							</div>
						</div>
					</div>
