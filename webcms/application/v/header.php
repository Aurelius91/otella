				...
				<div class="form-content">
					<div class="ui form">
						<div class="two fields">
							...
							<div class="field">
								<label>Name <span class="color-red warning"></span></label>
								<input id="header-name-lang-add" type="text" class="data-important-add" placeholder="Name..">
							</div>
							<!--<div class="field">
								<label>Upload Image <span class="color-red warning"></span></label>
								<input id="header-image-add" type="file" class="" placeholder="Upload Image.." accept="image/*">
				...
				<div class="form-content">
					<div class="ui form">
						<div class="two fields">
							...
							<div class="field">
								<label>Name <span class="color-red warning"></span></label>
								<input id="header-name-lang-edit" class="data-important-edit" placeholder="Name..">
							</div>
							<!--<div class="field">
								<label>Upload Image <span class="color-red warning"></span></label>
								<input id="header-image-edit" type="file" class="" placeholder="Upload Image.." accept="image/*">
								<div>Recommended Size: 1020px x 530px</div>
								<div>Max File Size: 500mb</div>
							</div>-->
						</div>
