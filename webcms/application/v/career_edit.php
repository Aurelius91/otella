					...
					<div class="ui form">
						...
						<div class="two fields">
							<div class="field">
								...
								<textarea id="career-requirement" placeholder="Requirement.."><?= $career->requirement; ?></textarea>
							</div>
							<div class="field">
								<label>Responsibility</label>
								<textarea id="career-responsibility" placeholder="Responsibility.."><?= $career->responsibility; ?></textarea>
							</div>
						</div>
						...
						<div class="two fields">
							<div class="field">
								<label>Requirement</label>
								<textarea id="career-requirement-lang" placeholder="Requirement.."><?= $career->requirement_lang; ?></textarea>
							</div>
							<div class="field">
								<label>Responsibility</label>
								<textarea id="career-responsibility-lang" placeholder="Responsibility.."><?= $career->responsibility_lang; ?></textarea>
							</div>
						</div>
