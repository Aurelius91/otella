	...
	*/
	...
	function initSlider(sliderWrapper) {
		...
		slider.on('swipeleft', function(event){
			nextSlide(slider, sliderControls, svgCoverLayer, sliderNavigation, pathArray, svgPath);
		});
		slider.on('swiperight', function(event){
			prevSlide(slider, sliderControls, svgCoverLayer, sliderNavigation, pathArray, svgPath);
		});
	}
	...
	function nextSlide(slider, sliderControls, svgCoverLayer, sliderNavigation, paths, svgPath) {
		...
		updateSlide(visibleSlide, nextSlide, 'next', svgCoverLayer, sliderNavigation, paths, svgPath);
	}
	function prevSlide(slider, sliderControls, svgCoverLayer, sliderNavigation, paths, svgPath) {
		var visibleSlide = retrieveVisibleSlide(slider),
				prevSlide = ( visibleSlide.prev('li').length > 0 ) ? visibleSlide.prev('li') : slider.find('li').last();
			updateSlide(visibleSlide, prevSlide, 'prev', svgCoverLayer, sliderNavigation, paths, svgPath);
	}
